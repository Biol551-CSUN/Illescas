...
p1 <- ggplot(data = Intertidal_Factors, 
                    aes(x = Quadrat   # assigning x and y values to be used
                        y = n,
                        fill = Quadrat)) +
            geom_point(aes(color = Quadrat, size = Quadrat, shape = Quadrat)) + # type of graph to make and add color, size and shape to points being plotted. 
